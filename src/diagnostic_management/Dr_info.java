...
public class Dr_info {
    ...
    private String D_id,D_Name,D_Phone,D_Special,D_VH,D_vf,D_Rnm,D_sts,D_ps;
    
    

    public Dr_info(String D_id, String D_Name, String D_Phone, String D_Special, String D_VH, String D_vf, String D_Rnm, String D_sts, String D_ps ) 
    {
        this.D_id = D_id;
        this.D_Name = D_Name;
    ...
    public void setD_ps(String D_ps) {
        this.D_ps = D_ps;
    }
}
